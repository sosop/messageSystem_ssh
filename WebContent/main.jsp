...
id=oTotal>222</B>&nbsp;封，其中&nbsp;<A title="" 
href="#">未读邮件</A>&nbsp;<B 
class=fnt_Red id=oTotalUnRead>123</B>&nbsp;封)</DIV>
...
<TABLE class="Ibx_gTable Ibx_gTable_Con" id=oTableCOUNT0 action="list">
  ...
  <TR class="I_Mark0 I_UnRd">
    ...
    <TD class=Ibx_Td_Chkbx><INPUT title=选择/不选 type=checkbox 
      ...
      read="false"></TD>
    <TD class=Ibx_Td_icoInfo><B class="icoIbx " title=未读(点击设为已读) 
      type="markread"></B></TD>
    <TD class="Ibx_Td_From " title=""><A 
      href="#">张三</A></TD>
    ...
    <TD class=Ibx_Td_Size><SPAN title="19,887 字节">19 K</SPAN></TD></TR>
  <TR class="I_Mark0 I_UnRd">
    <TD class=Ibx_Td_F>&nbsp;</TD>
    <TD class=Ibx_Td_Chkbx><INPUT title=选择/不选 type=checkbox 
      value=379:xtbBewcktUT-x2b5qAAAsm name=mid time="1236929126000" index="1" 
      read="false"></TD>
    <TD class=Ibx_Td_icoInfo><B class="icoIbx " title=未读(点击设为已读) 
      type="markread"></B></TD>
    ...
    <TD class=Ibx_Td_icoATCM></TD>
    <TD class=Ibx_Td_Size><SPAN title="11,737 字节">11 K</SPAN></TD></TR>
  <TR class="I_Mark0 I_UnRd">
    <TD class=Ibx_Td_F>&nbsp;</TD>
    <TD class=Ibx_Td_Chkbx><INPUT title=选择/不选 type=checkbox 
      value=379:xtbBexMktUT-x2ZbyAAAsw name=mid time="1236916339000" index="2" 
      read="false"></TD>
    <TD class=Ibx_Td_icoInfo><B class="icoIbx " title=未读(点击设为已读) 
      type="markread"></B></TD>
    <TD class=Ibx_Td_From title=colin@oceanmap.cn><A 
      href="#">张三</A></TD>
    <TD class=Ibx_Td_icoFlag title=未分类><B class=icoIbx></B></TD>
    <TD class=Ibx_Td_Subject title=""><A 
      href="#">张三</A></TD>
    <TD class=Ibx_Td_Date title="">11:52(五)</TD>
    <TD class=Ibx_Td_icoATCM></TD>
    <TD class=Ibx_Td_Size><SPAN title="375,612 字节">367 K</SPAN></TD></TR>
  <TR class="I_Mark0 I_UnRd">
    <TD class=Ibx_Td_F>&nbsp;</TD>
    <TD class=Ibx_Td_Chkbx><INPUT title=选择/不选 type=checkbox 
      value=360:xtbBaBEktUfQ-1JIHAAAsG name=mid time="1236913076000" index="3" 
      read="false"></TD>
    <TD class=Ibx_Td_icoInfo><B class="icoIbx " title=未读(点击设为已读) 
      type="markread"></B></TD>
    <TD class=Ibx_Td_From title=guoqiaotouzi@126.com><A 
      href="#">张三</A></TD>
    <TD class=Ibx_Td_icoFlag title=未分类><B class=icoIbx></B></TD>
    <TD class=Ibx_Td_Subject title=><A 
      href="#">张三</A></TD>
    ...
    <TD class=Ibx_Td_icoATCM></TD>
    <TD class=Ibx_Td_Size><SPAN title="4,700 字节">5 K</SPAN></TD></TR>
  <TR class=I_Mark0>
    <TD class=Ibx_Td_F>&nbsp;</TD>
    <TD class=Ibx_Td_Chkbx><INPUT title=选择/不选 type=checkbox 
      value=379:xtbBewAktUT-x2YexAAAsq name=mid time="1236912568000" index="4" 
      read="true"></TD>
    <TD class=Ibx_Td_icoInfo><B class="icoIbx icoRead" title=""></B></TD>
    <TD class=Ibx_Td_From 
    title=''><A 
      href="#">张三</A></TD>
    <TD class=Ibx_Td_icoFlag title=未分类><B class=icoIbx></B></TD>
    ...
    <TD class=Ibx_Td_icoATCM></TD>
    <TD class=Ibx_Td_Size><SPAN title="5,148 字节">5 K</SPAN></TD></TR>
  <TR class="I_Mark0 I_UnRd">
    <TD class=Ibx_Td_F>&nbsp;</TD>
    <TD class=Ibx_Td_Chkbx><INPUT title=选择/不选 type=checkbox 
      value=360:xtbBaAUjtUfQ-1FwagAAsY name=mid time="1236882334000" index="5" 
      read="false"></TD>
    <TD class=Ibx_Td_icoInfo><B class="icoIbx " title=未读(点击设为已读) 
      type="markread"></B></TD>
    <TD class=Ibx_Td_From title=""><A 
    ...
    <TD class=Ibx_Td_icoATCM></TD>
    <TD class=Ibx_Td_Size><SPAN title="14,609 字节">14 K</SPAN></TD></TR>
